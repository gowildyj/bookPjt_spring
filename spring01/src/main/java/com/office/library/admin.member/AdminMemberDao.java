...
public class AdminMemberDao {
    ...
    public boolean isAdminMember(String a_m_id) {
        System.out.println("AMDao-isAdminMember()");
    ...
    public int insertAdminAccount(AdminMemberVo adminMemberVo) {
        System.out.println("AMDao-insertAdminAccount()");
    ...
    public AdminMemberVo selectAdmin(AdminMemberVo adminMemberVo) {
        System.out.println("AMDao-selectAdmin()");
        ...
        try {
            ...
            if (!passwordEncoder.matches(adminMemberVo.getA_m_pw(),
                    adminMemberVoList.get(0).getA_m_pw()))
    ...
    public List<AdminMemberVo> selectAdminList() {
        System.out.println("AMDao-selectAdminList()");
        ...
        try {
            adminMemberVoList = jdbcTemplate.query(sql, new RowMapper<AdminMemberVo>() {
                ...
                public AdminMemberVo mapRow(ResultSet rs, int rowNum) throws SQLException {
                    ...
                    adminMemberVo.setA_m_phone(rs.getString("a_m_phone"));
                    adminMemberVo.setA_m_reg_date(rs.getString("a_m_reg_date"));
                    adminMemberVo.setA_m_reg_date(rs.getString("a_m_mod_date"));
    ...
    public int updateAdminAccount(int a_m_no) {
        System.out.println("AMDao-updateAdminAccount()");
...
//        String sql = "UPDATE tbl_admin_member SET a_m_approval = 1 WHERE a_m_no = ?";
    ...
    public int updateAdminAccount(String a_m_id, String newPassword) {
        System.out.println("AMDao-updateAdminAccount()");
